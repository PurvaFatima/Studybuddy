...
const MainContent = () => {
  // Initialize tasks state with dummy data for live edits
  ...
  return (
    <main className="flex-1 pt-0 pb-6 px-6 space-y-10">
      {/* ---------- Page Header ---------- */}
      <h1 className="text-4xl font-bold mb-2 pb-6 pt-0">Important Reminders ‼</h1>
